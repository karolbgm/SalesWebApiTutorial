...
namespace SalesWebApiTutorial.Controllers
{
    ...
    public class EmployeesController : ControllerBase
    {
        ...
        {
            var employee = await _context.Employees.SingleOrDefaultAsync(x => x.Email == email && x.Password == password); //singleordefault says if we don't find it, it makes it null
            if (employee is null)
            {
                return NotFound();
            }
